...
model_name_or_path="/work/yyy/ir-research/llm_as_retriever_data/checkpoints/mntp/llama3-8b-msmarco/bimodel" 
...
NGPU=4
# 4 A100, ep=8, bs=64, ef_bs=512 takes 38hours - 40hours (roughly 2 days)
...
for (( i=0; i<${#list_of_tuples[@]}; i+=3 )); do
    ...
    run_name=llama3-8b-marco-mntp-dense-mgmse-lora-${lr}_bs_${batch_size}_ep_${num_train_epochs}_l2norm
