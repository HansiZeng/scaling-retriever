...
for (( i=0; i<${#list_of_tuples[@]}; i+=4 )); do
    ...
    run_name=llama3-8b-marco-mntp-sparse-nce-kldiv-lora-${lr}_qreg_${query_reg}_dreg_${doc_reg}_bs_${batch_size}_epochs_${epochs}_nnegs_${n_negs}
